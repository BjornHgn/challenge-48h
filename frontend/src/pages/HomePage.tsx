...
const HomePage = () => {
  ...
  const systemStats = {
    totalBikes: stations.reduce((sum, station) => sum + station.num_vehicles_available, 0),
    totalStations: stations.length,
    activeUsers: 12540, // À remplacer par une vraie donnée de l'API
    dailyRides: 4328 // À remplacer par une vraie donnée de l'API
  };
    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="header">
        <div className="header-container">
          ...
          <nav className="nav-links">
            ...
            {isAuthenticated ? (
              <Link to="/profile" className="nav-link">Mon compte</Link>
            ) : (
      ...
      <main className="pt-[60px]">
        ...
        <section className="hero-section">
          <div className="tbm-container hero-content">
            ...
            <div className="flex flex-wrap gap-6 animate-fadeInUp" style={{ animationDelay: '0.4s' }}>
              <Link to="/map" className="modern-btn modern-btn-primary">
                Voir la carte
              </Link>
              {!isAuthenticated && (
                <Link to="/register" className="modern-btn modern-btn-outline">
                  Créer un compte
                </Link>
              )}
            </div>
          ...
          <div className="tbm-container">
            <div className="stats-grid">
              <div className="stat-card">
                <div className="stat-number">{systemStats.totalStations}</div>
                <div className="stat-label">Stations</div>
              </div>
              <div className="stat-card">
                <div className="stat-number">{systemStats.totalBikes}</div>
                <div className="stat-label">Vélos</div>
              </div>
              <div className="stat-card">
              ...
              <div className="stat-card">
                <div className="stat-number">{systemStats.dailyRides}</div>
                <div className="stat-label">Trajets par jour</div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="map-section">
          <div className="tbm-container">
            <h2 className="text-4xl font-bold mb-8 text-secondary">Nos stations</h2>
            {loading ? (
          ...
          <div className="footer-grid">
            <div className="footer-section">
              ...
              <ul className="footer-links">
                <li><Link to="/about" className="footer-link">Qui sommes-nous</Link></li>
            ...
            <div className="footer-section">
              <h3>Services</h3>
              <ul className="footer-links">
                <li><Link to="/map" className="footer-link">Carte des stations</Link></li>
                <li><Link to="/tarifs" className="footer-link">Tarifs</Link></li>
                <li><Link to="/app" className="footer-link">Application mobile</Link></li>
              </ul>
            </div>
            ...
            <div className="footer-section">
              ...
              <ul className="footer-links">
                ...
                <li><Link to="/help" className="footer-link">Aide</Link></li>
                <li><Link to="/maintenance" className="footer-link">Maintenance</Link></li>
              </ul>
            </div>
